...
export default function EmptyNotice({ message }: EmptyNoticeProps) {
  return (
    <div className="flex flex-col items-center gap-1 rounded-lg bg-neutral-pure-white px-4 py-10 text-center">
      <p className="text-14 font-medium text-text-main">{message}</p>
