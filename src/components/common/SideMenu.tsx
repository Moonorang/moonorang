...
const ITEM_CLASS =
  'flex w-full items-center border-b border-border-light-gray py-4 text-14 leading-fixed font-bold text-text-main';
...
export default function SideMenu({
  ...
  return (
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-(--z-modal) mx-auto max-w-(--width-container)">
          <motion.button
            type="button"
            aria-label="메뉴 닫기"
            onClick={onClose}
          ...
          <motion.aside
            ...
            className="absolute top-0 right-0 flex h-full w-[70%] flex-col bg-neutral-pure-white"
          >
